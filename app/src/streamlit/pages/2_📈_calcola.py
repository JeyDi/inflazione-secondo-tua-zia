...
# from app.src.core.datasets import fetch_data
...
# def table_customizable_page():
#     # https://share.streamlit.io/pablocfonseca/streamlit-aggrid/main/examples/example.py
#     # Example controlers
#     st.markdown("# Customizable table widget")
#     st.sidebar.header("Customizable table widget")
...
#         "Update Mode", list(GridUpdateMode.__members__), index=6
#     )
...
#         selection_mode: str = st.sidebar.radio(
#             "Selection Mode", ["single", "multiple"], index=1
#         )
...
#             rowMultiSelectWithClick: bool = st.sidebar.checkbox(
...
#         # show_code(table_customizable_page)


# table_customizable_page()
